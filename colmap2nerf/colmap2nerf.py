...
def parse_args():
	...
	parser.add_argument("--images", default="/home/sulutong/mr2nerf-master/colmap2nerf/Real_World_Trans/bonsai/images_8", help="Input path to the images.")
	parser.add_argument("--text", default="/home/sulutong/mr2nerf-master/colmap2nerf/Real_World_Trans/stump/colmap/1", help="Input path to the colmap text files (set automatically if --run_colmap is used).")
	...
	parser.add_argument("--out", default="/home/sulutong/mr2nerf-master/colmap2nerf/colmap_out/stump/transforms_train.json", help="Output JSON file path.")
